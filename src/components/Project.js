    ...
    en: [
      {
        image: Riwa,
        title: 'Riwa',
        description: "<b>Riwa</b> is a puzzle and exploration game developed in 3D using Unity as part of the Grand Projet Commun for the final year of the Bachelor's program at Gaming Campus. Our team of 28 members, including Artists, Business students, Technical designers, Musicians and Developers, had one month to create a commercially viable mobile game. In this game, we explore the concept of shifting between past and present timelines, which adds variety to the environments, atmosphere, and gameplay mechanics. For this mobile demo, we aimed to showcase as many mechanics as possible that could eventually be included in the full version of the game, such as a procedural checkerboard, controlling a soul that can interact with the surrounding nature, and more.<br></br><b>Awards Received:</b> <br /> <b>The Rookies 2025 | Game Of The Year - Mobile</b> <br /> <b>Gaming Campus Awards 2025 | Best Gameplay</b> <br></br>APK of the project: <a href='https://jfabregoule.itch.io/riwa' target='_blank' rel='noopener noreferrer' style='color: blue; text-decoration: underline;'>Download here (itch.io link)</a>"
      },
      {
        image: Malartre,
        title: 'Mystère dans les Halls',
        description: "Mystère dans les Halls is a mobile 'serious game' for the Henri Malartre Automobile Museum in Lyon, developed in Unity as part of a volunteer project. The goal of the project was to work as a team to create a 3D environment in Unity that closely replicates the museum's hangars, as well as three mini-games designed to introduce players to the museum, potentially encouraing new visitors to come. <br /><br /><b>App available on the Android store</b>"
      },
      {
        image: Uneven,
        title: 'Uneven',
